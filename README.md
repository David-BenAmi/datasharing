...
This repository is archived and no longer maintained. It represents educational reference material and is kept for historical purposes only.
...
Always encode every piece of information about your observations using text. For example, if you are storing data in Excel and use a form of colored text or cell background formatting to indicate the values of a variable, then this information will be lost when the file is exported as an Excel file! Always use text.
